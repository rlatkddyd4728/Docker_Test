...
# RUN touch /var/log/test/access_log
# RUN sed -i 's#CustomLog "logs/access_log" combined#CustomLog "/var/log/test/access_log" combined#g' /etc/httpd/conf/httpd.conf
